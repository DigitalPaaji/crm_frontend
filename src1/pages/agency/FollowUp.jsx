...
const FollowUp = () => {
  ...
  const followupdata = searchParams.get("followupdata") || 3;
  ...
  const fetchMyLeads = async (query) => {
    try {
      setLoading(true);
      setError(null);
  ...
  useEffect(() => {
    fetchMyLeads(`followupdata=${followupdata}`);
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
        ...
        <div className="relative min-w-[200px]">
          ...
          <select
            value={followupdata}
            onChange={(e) => navigate(`?followupdata=${e.target.value}`)}
